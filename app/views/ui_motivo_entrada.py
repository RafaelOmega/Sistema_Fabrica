...
################################################################################
## Form generated from reading UI file 'motivo_entradaurRoAk.ui'
##
...
class Ui_Motivo_Entrada(object):
    def setupUi(self, Motivo_Entrada):
        if not Motivo_Entrada.objectName():
            Motivo_Entrada.setObjectName(u"Motivo_Entrada")
        Motivo_Entrada.resize(852, 387)
        font = QFont()
        font.setFamilies([u"Segoe UI Semibold"])
        font.setPointSize(10)
        font.setBold(True)
        Motivo_Entrada.setFont(font)
        self.horizontalLayout = QHBoxLayout(Motivo_Entrada)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.frm_Entrada = QFrame(Motivo_Entrada)
        ...
        self.frm_Codigo = QFrame(self.frm_Entrada)
        ...
        self.frm_Descricao = QFrame(self.frm_Entrada)
        ...
        self.frm_Lista = QFrame(Motivo_Entrada)
        ...
        self.horizontalLayout_5.addWidget(self.lb_Pesquisar)

        self.txt_Pesquisar = QLineEdit(self.frm_Pesquisar)
        ...
        self.horizontalLayout_5.addWidget(self.txt_Pesquisar)

        self.bt_Pesquisar = QPushButton(self.frm_Pesquisar)
        ...
        QMetaObject.connectSlotsByName(Motivo_Entrada)
    # setupUi
    ...
    def retranslateUi(self, Motivo_Entrada):
        ...
        self.chk_Baixa_Ficha.setText(QCoreApplication.translate("Motivo_Entrada", u"Baixa Ficha Tecnica", None))
