...
class Ui_Pesquisa_Fichas_Tecnicas(object):
    def setupUi(self, Pesquisa_Fichas_Tecnicas):
        ...
        font.setBold(True)
        Pesquisa_Fichas_Tecnicas.setFont(font)
        self.verticalLayout = QVBoxLayout(Pesquisa_Fichas_Tecnicas)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.frm_Filtro = QFrame(Pesquisa_Fichas_Tecnicas)
        ...
        self.tb_Fichas_Tecnicas = QTableView(self.frm_Lista)
        self.tb_Fichas_Tecnicas.setObjectName(u"tb_Fichas_Tecnicas")
        ...
        QMetaObject.connectSlotsByName(Pesquisa_Fichas_Tecnicas)
    # setupUi
