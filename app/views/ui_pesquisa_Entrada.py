...
################################################################################
# Form generated from reading UI file 'pesquisa_EntradaBEbLmJ.ui'
##
...
class Ui_Pesquisa_Prod(object):
    def setupUi(self, Pesquisa_Prod):
        ...
        self.tb_Entradas = QTableView(self.frm_Lista)
        self.tb_Entradas.setObjectName(u"tb_Entradas")

        self.verticalLayout_2.addWidget(self.tb_Entradas)
    ...
    def retranslateUi(self, Pesquisa_Prod):
        Pesquisa_Prod.setWindowTitle(QCoreApplication.translate(
            "Pesquisa_Prod", u"Pesquisa Entradas", None))
        self.lb_Pesquisa.setText(QCoreApplication.translate(
            "Pesquisa_Prod", u"Pesquisar:", None))
        self.bt_Pesquisa.setText(QCoreApplication.translate(
            "Pesquisa_Prod", u"Confirmar", None))
    # retranslateUi
