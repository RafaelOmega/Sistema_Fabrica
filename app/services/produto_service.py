...
class ProdutoService:
    ...
    def salvar(self, codigo, descricao, peso, custo, produto_id=None):
        ...
        try:
            ...
            # Cobre a corrida em que dois usuários salvam o mesmo código
            # ao mesmo tempo: a checagem acima passou para ambos, mas o
            # banco rejeita o segundo INSERT/UPDATE pela constraint única.
            logger.warning(
